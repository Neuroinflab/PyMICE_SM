...
FIGURES=figures/example2_Figure_1.pdf figures/example3_Figure_1.pdf figures/example4_Figure_1.pdf
...
example%.tex figures/example%_Figure_1.pdf: example%.texw
	${WEAVE} $<
